...
class visualize_rotatingEnergyColor:
    def __init__(self,id):
        ...
        self.description = {
            "name": "Rotating Energy Color",
            "description": "Energy effekt that moves around the strip with dynamic colors",
            "effektSystemName": "visualize_rotatingEnergyColor",
            "group": "moving",
            "groupColor": "#44bd32",
    ...
    def run(self, y,stripSize,gain: dsp.ExpFilter,instanceData: dict = {}):
        ...
        for i in loopRange:
            ...
            tempP[0, i-rOff:i+rOff] =+ self.colors[0][0]
            tempP[1, i-rOff:i+rOff] =+ self.colors[0][1]
            tempP[2, i-rOff:i+rOff] =+ self.colors[0][2]

            tempP[0, i-gOff:i+gOff] =+ self.colors[1][0]
            tempP[1, i-gOff:i+gOff] =+ self.colors[1][1]
            tempP[2, i-gOff:i+gOff] =+ self.colors[1][2]

            tempP[0, i-bOff:i+bOff] =+ self.colors[2][0]
            tempP[1, i-bOff:i+bOff] =+ self.colors[2][1]
            tempP[2, i-bOff:i+bOff] =+ self.colors[2][2]
