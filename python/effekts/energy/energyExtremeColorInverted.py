...
class visualize_energyExtremeColorInverted:
    def __init__(self, id):
        self.id = id
        self.p = None
        self.p_filt = None
        self.description = {
            "name": "Energy extreme Color inverted",
            "description": "Expands from the center with increasing sound energy, but in Extreme colors and inverted",
    ...
    def run(self, y, stripSize, gain: dsp.ExpFilter, instanceData: dict = {}):
        ...
        scale = 0.85 * instanceData["intensity"]
