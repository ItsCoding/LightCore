...
class StripFrame:
    ...
    def addFrame(self, frame, startIndex: int, endIndex: int):
        ...
        for i in range(3):
            ...
            self.leds[0, startIndex:endIndex] = [int(i * brightness) for i in self.leds[0, startIndex:endIndex]]
            self.leds[1, startIndex:endIndex] = [int(i * brightness) for i in self.leds[1, startIndex:endIndex]]
            self.leds[2, startIndex:endIndex] = [int(i * brightness) for i in self.leds[2, startIndex:endIndex]]
